...
RSpec.describe Game do
  ...
  describe '#validate_piece_coordinates' do
    ...
    context 'when board.piece? return true' do
      before do
    ...
    context 'when board.piece? return false' do
      before do
  ...
  describe '#validate_move' do
    ...
    context 'when board.valid_piece_movement? return true' do
      before do
    ...
    context 'when board.valid_piece_movement? return false' do
      before do
  ...
  describe '#validate_active_piece' do
    ...
    context 'when board.active_piece_moveable? return true' do
      before do
    ...
    context 'when board.active_piece_moveable? return false' do
      before do
